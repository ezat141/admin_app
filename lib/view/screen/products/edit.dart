...
import 'package:admin_app/controller/products/edit_controller.dart';
...
class ProductsEdit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(ProductsEditController());
    return Scaffold(
      appBar: AppBar(
        title: const Text("Edit Product"),
      ),
      body: GetBuilder<ProductsEditController>(
                  ...
                  child: ListView(
                    children: [
                      ...
                      RadioListTile(
                        ...
                        value: false, groupValue: controller.active, onChanged: (val){
                      ...
                      RadioListTile(
                        ...
                        value: true, groupValue: controller.active, onChanged: (val){
                          controller.changeStatusActive(val);
                        }),
